...
outputFileMC = 'quarterCore_MC_output_70G_aniso.json'
...
plotSpatialTallyCompare_MCRR(outputFileMC, outputFileRR, tallyName_MC, tallyName_RR, normalise_by_mean='non-zero', response_index_MC=0, visualise_quarter=False)
